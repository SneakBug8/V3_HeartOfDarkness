...
| Category  | Story                                                        | Status                      | StatusV2 |
| --------- | ------------------------------------------------------------ | --------------------------- | -------- |
...
|           | Make plantation/agro economy cheaper to build<br />Ребаланс стоимости строительства домиков. Индустрия в разы дороже. | Hypothesis testing          |          |
|           | Buffed slave trade<br />(500 slaves per week, stronger debt slavery) | Done                        |          |
|           | Slavery gives 20% throughput to agricultural and plantations | Done                        |          |
|           | Serfdom gives 20% throughput to mines and logging            |                             |          |
|           | Bigger Gold reserves<br />(0.2 -> 0.3)                       | Done                        |          |
|           | The maximum trade route level has been increased from 100 to 1000 levels. | Done                        |          |
|           | Fix stockpiling gold by smaller AIs                          | Fine adjustment             | NA       |
|           | Rebalanced art galleries (twice inputs, twice outputs)       | Done                        | NA       |
|           | Stronger industrialized S-P, weaker agrarian Two Sicilies    | Done                        | NA       |
|           | Rebalance iron and coal mines across the map (overall reduction) | Fine adjustment             | NA       |
|           | Rebalance silk, cotton and dyes across the map (overall reduction) | Fine adjustment             | NA       |
|           | Rebalance tobacco, tea, coffee across the map (overall reduction) | Fine adjustment             | NA       |
...
|           | Countries whose market got forcefully opened get 30 tech spread bonus | Done                        | Done     |
|           | Countries whose slavery got forcefully banned get 10% production tech bonus | Done                        | Done     |
...
|           | Establishing global currency<br />Benefits for the leader, negative effects when country changes |                             |          |
|           | Impossible to build industry buildings in unincorporated states |                             |          |
| Diplomacy | Diplomatic action to make puppet a dominion                  | Done                        |          |
|           | Germany is formed with pan-nationalism tech instead of nationalism | Done                        |          |
...
|           | Decision to occupy full state before other party starts diploplay to return it | Done                        |          |
...
|           | Germany wants STATE_ALSACE_LORRAINE                          | Done                        | Done     |
|           | Japan is opened up and gets Meiji restoration                | Done                        |          |
|           | Wallachia and Moldavia unite                                 | Done                        | NA       |
|           | US fulfills manifest destiny                                 | Done                        |          |
|           | Nerf Austrian army before it reforms into Austro-Hungary     | Discussion                  |          |
|           | Hungary is subject of Austria at the start                   | Done                        | Done     |
|           | Austria annexes Hungary when finishing "The matter of Hungary" JE. |                             | Testing  |
|           | Poland is subject of Russia at the start<br />Subject type: Personal union or Puppet? | Done                        | Done     |
...
| Politics  | Stronger Springtime of the peoples                           | Done                        | NA       |
|           | IGs twice more impacted by existing laws                     | Too many revolutions for AI |          |
|           | Stronger conservative laws (busted with bureaucracy discounts and pop growth) | Done                        | Done     |
